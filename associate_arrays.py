...
def unicode_conversion(single_letter):
    # this function returns hexadecimal from
    # single letters of the sentence/word.
    unicode_hex = {}
    unicode_hex['A'] = "41"
    unicode_hex['B'] = "42"
    unicode_hex['C'] = "43"
...
def main():
    ...
    word_string = input("Please enter a word/sentence: ")
    for single_letter in word_string:
